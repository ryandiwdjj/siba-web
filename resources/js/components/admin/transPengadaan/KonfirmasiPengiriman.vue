                ...
                <div class="card-body">
                    ...
                    <form v-on:submit.prevent="saveForm()" class="form-horizontal" >
                      ...
                      <div class="form-group">
                        <label for="name" class="col-md-2 control-label" >Status Pengiriman</label>
                        <br>
                      ...
                      <div class="form-group">
                        <div class="col-md-4 col-md-offset-2">
                          ...
                          <router-link to = "/trans_pengadaan_konfirmasi" class="button is-warning">Batal  &nbsp; <i class="fas fa-window-close"></i></router-link>
                        </div>
                      </div>
                      <br>
                    </form>
