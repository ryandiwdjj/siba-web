                  ...
                  <div class="card-tools">
                    ...
                    <tbody>
                      <tr v-for="(detail_trans_sparepart,index) in filteredList" :key ="detail_trans_sparepart.id">
                        ...
                        <td>{{ detail_trans_sparepart.sparepart.nama_sparepart }}</td>
    ...
    computed: {
       filteredList: function(){
         return this.detail_transsparepart.filter((detail_trans_sparepart) => {
           return detail_trans_sparepart.sparepart.nama_sparepart.toLowerCase().match(this.pencarian.toLowerCase());
         });
       }
    },
    methods: {
